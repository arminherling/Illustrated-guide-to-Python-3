# Exercise: Copy the cat.py code. Get it working on your computer. This isn’t just busy work.
# Much of the time when you are programming, you aren’t creating something from
# scratch, but rather are reusing code that others have written.
